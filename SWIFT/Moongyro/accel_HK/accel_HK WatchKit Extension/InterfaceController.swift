...
class InterfaceController: WKInterfaceController, HKWorkoutSessionDelegate, WCSessionDelegate {
    ...
    func session(_ session: WCSession, didReceiveMessage message: [String : Any]) {
        ...
        errorCode = (message["phoneToWatchMsg"]! as? String)!
        Error_Handler.setText("\(errorCode)")
    ...
    func outputAccelerationData(acceleration: CMAcceleration){
        ...
        accel_SX = String(round(1000000*acceleration.x)/1000000)
        accel_SY = String(round(1000000*acceleration.y)/1000000)
        accel_SZ = String(round(1000000*acceleration.z)/1000000)
